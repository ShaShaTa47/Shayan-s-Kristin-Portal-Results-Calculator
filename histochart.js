//from Chart.js at https://www.chartjs.org/docs/latest/
/*!
* Chart.js v2.9.3
...
!(function (t, e) {
    ...
    var bn = X.extend({
        ...
        _parseValue: function (t) {
            var e, n, i, a;
            return (
                on(t) ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n))) : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t), (a = t)),
        ...
        _drawGrid: function () {
            ...
            if (
                ...
                for (
                    ...
                    a.lineWidth = l,
                    a.strokeStyle = u,
                    a.setLineDash && (a.setLineDash(En([s.borderDash, o.borderDash, []])), (a.lineDashOffset = En([s.borderDashOffset, o.borderDashOffset, 0]))),
